...
var setRound = Object.values(document.querySelector('#app > div > div'))[1].children[1]['_owner'].stateNode.state,
  roundPrompt = parseInt(prompt('What round do you want to be at?'))
setRound.round = roundPrompt
