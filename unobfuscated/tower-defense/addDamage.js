...
var addDamage = Object.values(document.querySelector('#app > div > div'))[1].children[1]['_owner'].stateNode,
  damagePrompt = parseInt(prompt('How much damage do you want?'))
addDamage.dmg = damagePrompt
